...
class FinalConvergenceFacadeTests(unittest.TestCase):
    ...
    def test_course_wizard_entrypoints_are_canonical(self):
        ...
        self.assertIn('data-csp-click="courseWizard681Create()"', self.wizard)
        self.assertIn('data-csp-click="courseWizard681Reset()"', self.wizard)
        self.assertIn('/course-wizard-681.js', self.system)
