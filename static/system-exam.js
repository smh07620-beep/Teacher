...
async function submitQuiz() {
    ...
    try {
        result=await secureExamApi(`/api/exam-attempts/${encodeURIComponent(attemptId)}/submit`,{
            ...
            body:JSON.stringify({answers:userAnswers,evaluatorName:evaluatorNameInput,evaluatorTitle:evaluatorTitleInput,examineeRole:roleInput})
        });
    } catch (error) {
        console.error(error);
