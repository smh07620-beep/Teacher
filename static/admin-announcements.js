...
(function(){
  ...
  async function createAdminAnnouncement(){
    ...
    const r=await fetch('/api/announcements',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({title,body,active:true})});
