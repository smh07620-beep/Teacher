"""Canonical owner of the legacy PGY HTTP compatibility surface.
...
``teacher_app.pgy``; this module keeps the legacy error/URL projection while
delegating state and persistence to canonical services.
"""
